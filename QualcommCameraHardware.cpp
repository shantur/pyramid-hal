...
mm_camera_status_t (*LINK_mm_camera_get_camera_info) (cam_dev_info_t* p_cam_info, int* p_num_cameras);
...
static cam_dev_info_t HAL_cameraInfo[MSM_MAX_CAMERA_SENSORS];
